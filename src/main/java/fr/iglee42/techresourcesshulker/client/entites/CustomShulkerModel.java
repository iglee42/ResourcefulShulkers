package fr.iglee42.techresourcesshulker.client.entites;
...
@OnlyIn(Dist.CLIENT)
public class CustomShulkerModel<T extends CustomShulker> extends ListModel<T> {
   ...
   public CustomShulkerModel(ModelPart p_170922_) {
