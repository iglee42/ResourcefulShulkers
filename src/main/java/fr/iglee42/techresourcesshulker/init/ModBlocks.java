...
import fr.iglee42.techresourcesshulker.blocks.*;
...
public class ModBlocks {
    ...
    public static void createBox(ResourceLocation id){
        ...
        ModBlocks.createBlock(res.id().getPath()+ "_generating_box", ()->new GeneratingBoxBlock(id), new Item.Properties().tab(TechResourcesShulker.SHULKERS_GROUP));
    }
