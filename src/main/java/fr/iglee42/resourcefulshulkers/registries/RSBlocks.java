...
public class RSBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(BuiltInRegistries.BLOCK, RSIds.MODID);


    public static final DeferredHolder<Block,Block> SHULKER_INFUSER = createBlock("shulker_infuser",ShulkerInfuserBlock::new);
    public static final DeferredHolder<Block,Block> SHULKER_PEDESTAL = createBlock("shulker_pedestal", ShulkerPedestalBlock::new);
    public static final DeferredHolder<Block,Block> SHULKER_ABSORBER = createBlock("shulker_absorber", ShulkerAbsorberBlock::new);

    public static final DeferredHolder<Block,Block> PURPUR_TARGET = createBlock("purpur_target", PurpurTargetBlock::new);
    ...
    public static final DeferredHolder<Block, Block> END_CITY = createBlock("end_city", ()->new EndCityBlock(BlockBehaviour.Properties.of().strength(3f,10f).noOcclusion(),1));
    public static final DeferredHolder<Block, Block> END_CITY_TIER_2 = createBlock("end_city_tier_2", ()->new EndCityBlock(BlockBehaviour.Properties.of().strength(3f,10f).noOcclusion(),2));
    public static final DeferredHolder<Block, Block> TRAINER = createBlock("shulker_trainer", ()->new TrainerBlock(BlockBehaviour.Properties.of().strength(3f,10f).noOcclusion()));
    public static final DeferredHolder<Block, Block> STRUCTURE = createBlockWithoutItem("structure", ()->new StructureBlock(BlockBehaviour.Properties.of().noLootTable().strength(3f,10f).noOcclusion()));

    public static DeferredHolder<Block,Block> createBlock(String name, Supplier<? extends Block> supplier)
    {
    ...
    // Shulker Blocks
    public static DeferredHolder<Block,Block> createGeneratingBox(IShulkerDefinition shulker){
        DeferredHolder<Block, Block> box = BLOCKS.register(shulker.id().getPath()+"_generating_box", ()->new GeneratingBoxBlock(shulker));
