...
public class ModItems {
    ...
    public static final RegistryObject<Item> SHULKER_ITEM = ITEMS.register("shulker_item", () -> new ShulkerItem(new Item.Properties().tab(ResourcefulShulkers.GROUP), EntityType.SHULKER));
    public static final RegistryObject<Item> OVERWORLD_SHULKER_ITEM = ITEMS.register("overworld_shulker", () -> new ShulkerItem(new Item.Properties().tab(ResourcefulShulkers.GROUP),null));
    public static final RegistryObject<Item> SKY_SHULKER_ITEM = ITEMS.register("sky_shulker", () -> new ShulkerItem(new Item.Properties().tab(ResourcefulShulkers.GROUP),null));
    public static final RegistryObject<Item> NETHER_SHULKER_ITEM = ITEMS.register("nether_shulker", () -> new ShulkerItem(new Item.Properties().tab(ResourcefulShulkers.GROUP),null));
    public static final RegistryObject<Item> END_SHULKER_ITEM = ITEMS.register("end_shulker", () -> new ShulkerItem(new Item.Properties().tab(ResourcefulShulkers.GROUP),null));
    public static final RegistryObject<Item> OVERWORLD_ESSENCE = ITEMS.register("overworld_essence", () -> new Item(new Item.Properties().tab(ResourcefulShulkers.GROUP)));
    public static final RegistryObject<Item> SKY_ESSENCE = ITEMS.register("sky_essence", () -> new Item(new Item.Properties().tab(ResourcefulShulkers.GROUP)));
    public static final RegistryObject<Item> NETHER_ESSENCE = ITEMS.register("nether_essence", () -> new Item(new Item.Properties().tab(ResourcefulShulkers.GROUP)));
    public static final RegistryObject<Item> END_ESSENCE = ITEMS.register("end_essence", () -> new Item(new Item.Properties().tab(ResourcefulShulkers.GROUP)));
    public static final RegistryObject<Item> BASE_ESSENCE = ITEMS.register("base_essence", () -> new Item(new Item.Properties().tab(ResourcefulShulkers.GROUP)));

    public static final RegistryObject<Item> UPGRADE_BASE = ITEMS.register("upgrade_base", ()-> new Item(new Item.Properties().tab(ResourcefulShulkers.GROUP)));
    ...
    public static final RegistryObject<Item> SHULKER_HEAD = ITEMS.register("shulker_head", ()-> new StandingAndWallBlockItem(ModBlocks.SHULKER_HEAD.get(),ModBlocks.WALL_SHULKER_HEAD.get(), new Item.Properties().tab(ResourcefulShulkers.GROUP)){
        @Override
