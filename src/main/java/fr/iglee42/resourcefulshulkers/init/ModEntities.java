...
public class ModEntities {
    ...
    public static DeferredHolder<EntityType<?>,EntityType<TypeShulker>> createTypeShulker(ResourceLocation id){
        ...
        ModItems.ITEMS.register(res.id().getPath().toLowerCase()+"_shulker", () -> new ShulkerItem(new Item.Properties(),null,Type.getById(ResourceLocation.fromNamespaceAndPath(MODID,"elemental")).id()));
        return entity;
    }
