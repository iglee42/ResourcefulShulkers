...
public enum BaseTypes {
    ...
    ALUMINUM("#c:ingots/aluminum", DyeColor.LIGHT_GRAY,"C2AEA0","overworld"),
    AMETHYST(Items.AMETHYST_SHARD, DyeColor.MAGENTA,"B38EF3","overworld"),
    BRASS("#c:ingots/brass", DyeColor.ORANGE,"E4B763","sky"),
    BRONZE("#c:ingots/bronze", DyeColor.ORANGE,"CE6E26","sky"),
    CLAY(Items.CLAY_BALL, DyeColor.LIGHT_GRAY,"A1A7B1","overworld"),
    COAL(Items.COAL, DyeColor.BLACK,"151515","overworld"),
    CONSTANTAN("#c:ingots/constantan", DyeColor.ORANGE,"AA7030","sky"),
    ...
    ELECTRUM("#c:ingots/electrum", DyeColor.YELLOW,"C9B255","sky"),
    ...
    INVAR("#c:ingots/invar", DyeColor.LIGHT_GRAY,"A3B1A8","sky"),
    IRON(Items.IRON_INGOT, DyeColor.WHITE,"E6E6E6","overworld"),
    LAPIS(Items.LAPIS_LAZULI, DyeColor.BLUE,"1E4285","sky"),
    LEAD("#c:ingots/lead", DyeColor.BLUE,"484E6A","overworld"),
    NETHERITE(Items.NETHERITE_SCRAP, DyeColor.BROWN,"4D494D","nether"),
    NICKEL("#c:ingots/nickel", DyeColor.YELLOW,"BCAD7E","overworld"),
    OBSIDIAN(Items.OBSIDIAN, DyeColor.PURPLE,"271E3D","nether"),
    OSMIUM("#c:ingots/osmium", DyeColor.LIGHT_GRAY,"A5B1BA","overworld"),
    QUARTZ(Items.QUARTZ, DyeColor.WHITE,"F2EFED","nether"),
    REDSTONE(Items.REDSTONE, DyeColor.RED,"7E0F00","sky"),
    REFINED_GLOWSTONE("#c:ingots/refined_glowstone", DyeColor.YELLOW,"EABE2B","nether"),
    REFINED_OBSIDIAN("#c:ingots/refined_obsidian", DyeColor.PURPLE,"4A3C64","end"),
    SIGNALUM("#c:ingots/signalum", DyeColor.RED,"ED3706","nether"),
    SILVER("#c:ingots/silver", DyeColor.LIGHT_GRAY,"758392","overworld"),
    ...
    private final String item, color, shellColor,type;
    ...
    BaseTypes(Item item, DyeColor color, String shellColor,String type) {
        this.item = item.toString().toString();
        this.color = color.toString();
        this.shellColor = shellColor;
        this.type = type;
    }
