...
public class ShellOutputRecipeCategory implements IRecipeCategory<IShulkerDefinition> {

    public static final RecipeType<IShulkerDefinition> RECIPE_TYPE = RecipeType.create(RSIds.MODID, "shell_output",
    ...
    public ShellOutputRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(RSBlocks.PURPUR_TARGET.get()));
    ...
    public Component getTitle() {
        return Component.literal("Shulker Shell Output");
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, IShulkerDefinition shulker, IFocusGroup iFocusGroup) {
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, 79, 1)
                .setBackground(slotBackground, -1 ,-1)
                .addItemLike(shulker.registration().shell().get());
        builder.addSlot(RecipeIngredientRole.CATALYST, 39 , 1)
                .addItemLike(RSBlocks.PURPUR_TARGET.get());
    }
